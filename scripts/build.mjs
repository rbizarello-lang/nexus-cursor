...
const outDemoExperimentalPath = path.join(root, 'demo_experimental.html');
...
// Cópia com nome explícito pedido para a Demo Experimental
...
console.log(`    + demo_experimental.html (${demoKb} KB) — mesmo artefato Demo`);
