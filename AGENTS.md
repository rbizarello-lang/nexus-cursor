...
- **Claude · Ardósia**: `uiEdition: 'claude'` — menu lateral com operações, Hoje e Intimações novos; demais telas vêm do app dentro da casca. Ativar via ⚙ ou `?edition=claude`. Código em `src/edition-claude.jsx`.
